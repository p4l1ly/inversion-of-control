...
type GoBool d m = E [k|recurBool|] (() -> [f|bool|] -> m Bool)
...
--   :+: Name "recurBool" RecPure.Go
--   :+: Name "recurInt" RecPure.Go
--   :+: Name "bool" Bool
--   :+: Name "int" Int
--   :+: End
-- 
